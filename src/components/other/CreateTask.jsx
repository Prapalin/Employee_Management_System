        ...
        className='flex flex-wrap items-start w-full justify-between'>
            <div className='w-1/2'>
                ...
                <div>
                    ...
                    className='scheme-dark text-sm text-white py-1 px-2 w-4/5 rounded outline-none bg-transparent placeholder:text-gray-600 border border-gray-400 mb-4' type="date" />
                </div>
                <div>
            ...
            <div className='w-1/2'>
                ...
                className='text-sm text-white h-44 py-2 px-4 w-4/5 rounded outline-none bg-transparent border border-gray-400 mb-4' placeholder='Add description'></textarea>
